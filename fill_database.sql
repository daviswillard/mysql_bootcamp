...
create table person (
    ...
    gender varchar(15) default 'female' not null,
    address varchar(30),
    primary key (id)
);
...
/*alter table person_visits add constraint uk_person_visits unique (person_id, pizzeria_id, visit_date);
alter table person_visits add constraint fk_person_visits_person_id foreign key (person_id) references person(id);
alter table person_visits add constraint fk_person_visits_pizzeria_id foreign key (pizzeria_id) references pizzeria(id);
*/
...
create table menu(
    ...
    constraint chk_menu_pizzeria_id foreign key (pizzeria_id) references pizzeria(id)
);
...
create table person_order (
    ...
    constraint chk_order_person_id foreign key (person_id) references person(id),
    constraint chk_order_menu_id foreign key (menu_id) references menu(id)
);
